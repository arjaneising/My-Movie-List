<?php
 ...
 #############################################################################
 # $Id: imdb_trailers.class.php 236 2009-10-06 15:23:07Z izzy $
  ...
  * @version $Revision: 236 $ $Date: 2009-10-06 17:23:07 +0200 (Di, 06. Okt 2009) $
  */
 class imdb_trailers {
	var $page = "";
	...
	function imdb_trailers(){
	  $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 236 $');
	}
