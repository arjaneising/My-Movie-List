<?php
 ...
 /* $Id: imdb_person.class.php 270 2009-11-24 21:48:16Z izzy $ */
  ...
  * @version $Revision: 270 $ $Date: 2009-11-24 22:48:16 +0100 (Di, 24. Nov 2009) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 270 $');
    $this->setid($id);
  }
