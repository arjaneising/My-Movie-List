<?php
 ...
 /* $Id: imdb.class.php 288 2009-11-29 20:51:33Z izzy $ */
  ...
  * @version $Revision: 288 $ $Date: 2009-11-29 21:51:33 +0100 (So, 29. Nov 2009) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 288 $');
    $this->setid($id);
  }
